...
- [GET /api/downloads](/api/downloads/list-downloads) - List all downloads with thumbnail URLs
- [DELETE /api/downloads/{download_id}/remove](/api/downloads/remove-download) - Remove download and thumbnail
