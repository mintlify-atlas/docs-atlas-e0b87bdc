...
- [GET /api/download/{download_id}/file](/api/download/get-file) - Download complete file (not streaming)
- [GET /api/downloads](/api/download/list-downloads) - List all downloads to get filenames
